...
def test_two_tower_encode_interface(tiny_hetero_graph):
    ...
    model = TwoTower(in_dims=in_dims, hidden_dim=64, num_layers=2, dropout=0.1)
...
def test_two_tower_different_dims(tiny_hetero_graph, hetero_graph_100_200):
    ...
    model1 = TwoTower(in_dims=in_dims1, hidden_dim=64, num_layers=2, dropout=0.1)
    ...
    edge_index_dict = {}
    model2 = TwoTower(in_dims=in_dims2, hidden_dim=128, num_layers=2, dropout=0.1)
...
def test_two_tower_forward_interface(tiny_hetero_graph):
    ...
    g = tiny_hetero_graph
    in_dims = {node_type: g[node_type].x.size(-1) for node_type in g.node_types}
    model = TwoTower(in_dims=in_dims, hidden_dim=64, num_layers=2, dropout=0.0)
    model.eval()
